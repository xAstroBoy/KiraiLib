...
namespace KiraiMod
{
    public static class Configuration
    {
        ...
        public static Color NewUser = new Color(0.09f, 0.47f, 1f);
        public static Color Visitor = new Color(0.8f, 0.8f, 0.8f);
        public static Color Nuisance = new Color(0.47f, 0.18f, 0.18f);
        public static Color Unknown = new Color(0.0f, 0.0f, 0.0f);
    }
}
